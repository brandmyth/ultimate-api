            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ url('admin/add-edit-homepage-banner') }}" class="btn btn-primary float-right">Add Banner</a>
                            ...
                            <table class="table table-bordered" id="ssDataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <a href="{{ url('admin/add-edit-homepage-banner/'.$ban['id']) }}"><i style="font-size: 1.5rem;" class="mdi mdi-pencil-box"></i>
                                            </a>
