            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">Manage Footer Advertisement</h3>
                    </div>
                	...
                	<div class="col-md-6 grid-margin stretch-card">
		              <div class="card">
		                <div class="card-body">
			              ...
			              @endif
		                  <form class="forms-sample" @if(empty($advertisement['id'])) action="{{ url('admin/add-edit-footer-advertisement') }}" @else action="{{ url('admin/add-edit-footer-advertisement/'.$advertisement['id']) }}" @endif method="post" enctype="multipart/form-data">
		                  	@csrf
