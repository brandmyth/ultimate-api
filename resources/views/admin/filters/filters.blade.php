            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ url('admin/add-edit-filter') }}" class="btn btn-primary float-right ml-3">Add Filter</a>
                         <a href="{{ url('admin/filter-values') }}" class="btn btn-primary float-right">View Filter Values</a>
