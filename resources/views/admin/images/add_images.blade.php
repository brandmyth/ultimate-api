                            ...
                            <table class="table table-bordered" id="attribute_table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	<img class="img-fluid" src="{{ asset('frontend/images/product_images/small/'.$image['image']) }}">
                                        </td>
                                        <td>
                                            @if($image['status'] == 1)
                                            ...
                                            @endif
                                            &emsp;
                                            <a href="javascript:void(0)" class="confirmDelete" module="image" moduleid="{{ $image['id'] }}"><i style="font-size: 1.5rem;" class="mdi mdi-file-excel-box"></i>
                                            </a>
                                   		 </td>
                                    </tr>
                                    @endforeach
